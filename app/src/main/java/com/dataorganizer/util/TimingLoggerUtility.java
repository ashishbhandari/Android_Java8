...
package com.dataorganizer.util;
 ...
 * <p>
 * <pre>
 *     TimingLoggerUtility timings = new TimingLoggerUtility(TAG, "methodA");
 *     // ... do some work A ...
 ...
 * </pre>
 */
public class TimingLoggerUtility {
    ...
    /**
     * Create and initialize a TimingLoggerUtility object that will log using
     ...
     */
    public TimingLoggerUtility(String tag, String label) {
        reset(tag, label);
    }

    /**
     * Clear and initialize a TimingLoggerUtility object that will log using
     * the specific tag. If the Log.isLoggable is not enabled to at
     * least the Log.VERBOSE level for that tag at creation time then
     * the addSplit and dumpToLog call will do nothing.
     *
    ...
    public void dumpToLog() {
        ...
        for (int i = 1; i < mSplits.size(); i++) {
            ...
            mStringBuffer.append(mLabel + ":  " + (now - prev) + " ms, " + splitLabel + "\n");
